  ...
  <tr>
	...
	<%
		...
		while(iterator.hasNext()){
			...
			ChatRoom  chatroom = (ChatRoom )hashmap.get(s2);
			...
			if(s != null && s.equals(s2)){
				if(chatroom.getRoomDescription().length() == 0){
					out.println("<br><div class=smallesttext>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;There is no Subject available.</div>");
				} 
				else{
					out.println("<br><div class=smallesttext>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;About: "+chatroom.getRoomDescription()+"</div>");		}
			}
		}
		%>
	</td></tr>
